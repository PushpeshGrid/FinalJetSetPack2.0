  ...
  return (
    <div className="text-[#6bb5ff]">
      <div className="max-w-[800px] mt-[-140px] w-full h-screen mx-auto text-center flex flex-col justify-center">
        <p className="text-[#131a18] font-bold p-2">Welcome to JetSetPack</p>
        ...
        <p className="md:text-2xl text-xl font-bold text-gray-500">
          {" "}
          Automate setup of core tools platforms.
        </p>

        <div>
          <button
            className="bg-[#00df9a] hover:bg-violet-400 w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black"
          ...
          >
            ...
            <DialogContent dividers>
              <Typography gutterBottom>
                A developer should not have to go through the hassle of
                searching for and installing required tools or, worse yet,
                manually installing the entire environment from scratch. We
                provide basic functionality to spin up development environments
                on a local machine with the required tools already installed and
                configured based on each user''s needs. We start with a couple
                of core options like setting up a local development machine,
                staging environment, production, etc., and then expand and
                customize them over time.
              </Typography>
              <Typography gutterBottom>
                Provide basic functionality to spin up development environments
                in the cloud with required tools installed and configured based
                on each company's needs. Start with a couple core options like
                local dev machine setup, staging environment, production, etc.
                Expand and customize over time.
              </Typography>
            </DialogContent>
            <DialogActions>
      ...
      <div className="flex justify-flex start text-center flex-col mt-[-150px]">
        <h2 className=" md:text-2xl mx-auto text-center flex flex-col justify-center mb-3">
          Steps to be followed by NEW USER{" "}
        </h2>

        <div>
          <button
            className="bg-[#0082df] hover:bg-violet-600  w-[100px] rounded-md font-medium mx-3 text-white mt-1"
          ...
          >
            ...
            <DialogContent dividers>
              ...
              <button
                className="flex justify-start my-2 text-[#bfc1c2]"
                onClick={handleCopyToClipboard1}
              >
                <FaCopy />
              </button>
              ...
              >
                ...
                jZbP+V7j3tJ9T3GXqCR8nLhpiYfZCtkO9knFtnacafgA/XHpMM=
                rsah@rsahs-MacBook-Pro.local" {">>"} ~/.ssh/authorized_keys
              </Typography>
              <button
                className="flex justify-start my-2 text-[#bfc1c2]"
                onClick={handleCopyToClipboard3}
              >
                <FaCopy />
              </button>
              ...
              <Typography gutterBottom class="text-base">
                5. Adding copied user to sudoer file. Replace $user with your
                username
              </Typography>
              ...
              <button
                className="flex justify-start my-2 text-[#bfc1c2]"
                onClick={handleCopyToClipboard4}
              >
                <FaCopy />
              </button>
              ...
              <button
                className="flex justify-start my-2 text-[#bfc1c2]"
                onClick={handleCopyToClipboard5}
              >
                <FaCopy />
              </button>
