...
export default function data() {
  ...
  return {
    columns: [
      { Header: "The project", accessor: "The project", width: "45%", align: "left" },
    ...
    rows: [
      {
         project: <Company image={logoXD} name="Basic system bug fixed" />,
        Members: (
      ...
      {
        ABC: <Company image={logoAtlassian} name="أضف مسار التقدم إلى التطبيق الداخلي" />,
        أعضاء: (
          <MDBox display="flex" py={1}>
            {avatars([
              [team2, "Romina Hadid"],
